...
{
    Product* ans = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return ans;
}
...
{
    Product* ans = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return ans;
...
{
    Product* ans = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return ans;
}
